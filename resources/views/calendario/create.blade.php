...
@section('page-title', 'Nuevo Evento Académico')

@section('content')
<div class="max-w-md mx-auto bg-white rounded shadow-sm border border-gray-100 p-6">
    <h2 class="text-lg font-semibold text-gray-800 mb-5">Crear Evento</h2>
    ...
    <form method="POST" action="{{ route('calendario.store') }}" class="space-y-4">
        @csrf
        <div>
        ...
        <div class="flex gap-3 pt-2">
            ...
            <a href="{{ route('calendario.index') }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-200 transition">
                Cancelar
            </a>
        </div>
    </form>
